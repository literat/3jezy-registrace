<div class="row margin-bottom-10">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        {{-- <i class="fa fa-facebook-official"></i> --}}<a href="{{ route('social.redirect', ['provider' => 'facebook']) }}" class="btn btn-lg waves-effect waves-light  btn-block facebook">Facebook</a>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12">
